...
import j24_User.controllor.AuthContoroller;
...
public class ApplicationMain {
	private AuthContoroller authContoroller;
	private Scanner scanner;
	
	public ApplicationMain() {
		scanner = new Scanner(System.in);
		authContoroller = new AuthContoroller(scanner, new AuthServiceImpl());
	}
	...
	private void start() {
		while(true) {
			...
			if(select.equals("1")) {
				CMRespDto<?> cmRespDto = authContoroller.signin();
				...
				showResponse(authContoroller.signup());	
